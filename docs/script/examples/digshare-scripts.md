...
- [主流数字货币价格波动提醒](https://github.com/digshare-scripts/digital-assets-volatility-monitor)
- [服务器证书过期监测](https://github.com/digshare-scripts/digshare-ssl-cert-expiration-monitor)
